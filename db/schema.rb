...
ActiveRecord::Schema.define(version: 20151224171615) do
  ...
  add_index "follows", ["follower", "followee"], name: "index_follows_on_follower_and_followee", unique: true, using: :btree
